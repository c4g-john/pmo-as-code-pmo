...
- **STD-RISK-001** (threatens: STD-BR-002): Spec-engine drift — the implementation evolves faster than the text. Probability: high. Impact: medium. Owner: johntanner. Response: conformance suite in engine CI makes drift a failing build; spec-first policy for behavior changes.
