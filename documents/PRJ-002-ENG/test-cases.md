...
- **ENG-TC-009** (tests: ENG-AC-009): Steps: render a page with execution data containing a closed and an open feature, then re-derive the RAG with and without the execution file. Expected: real spans and states on the lanes; identical RAG either way.
